...
SELECT * FROM DEV_PAS.T_CS_ACCEPT_CHANGE@BINGXING_168_15 TCAC WHERE  TCAC.ACCEPT_CODE IN ('6120180627063779')   INSERT_BY=22856 AND TO_CHAR(INSERT_TIME,'YYYYMMDD') = '20180625';
SELECT * FROM DEV_PAS.T_CS_APPLICATION@BINGXING_168_15 TCA WHERE TCA.CHANGE_ID = 168026;
SELECT * FROM DEV_PAS.T_UDMP_USER@BINGXING_168_15 B WHERE B.USER_ID = '930001755';
